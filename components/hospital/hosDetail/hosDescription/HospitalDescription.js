...
export default class hospitalDescription extends Component {
  constructor () {
    super()
    this.state = {
      open: false
          ...
          <Paper zDepth={1} className='paper'>
            <div>
              <Container style={styles.textCenter}>
                <p className='hospitalDescription'>{this.props.description}</p>
        ...
        <div>
          <MuiThemeProvider>
            <Dialog
             ...
             >
              <div>
                <p className='hospitalDescriptionDialog'>{this.props.description}</p>
              </div>
            </Dialog>
          </MuiThemeProvider>
        </div>
